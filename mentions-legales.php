				...
				<h2><strong>Politique en matière de données personnelles</strong></h2>
					<ul>
						...
						<li>1.2 Droits de l'utilisateur :</li>
							<p>Conformément à la loi n°78-17 du 6 janvier 1978 relative à l'information, aux fichiers et aux libertés, tout utilisateur dispose d'un droit d'accès, de rectification, de suppression des informations le concerne. Ce droit peut s'exercer en adressant un email à : contact@sortirgratos.fr.</p>
						<li>1.3 Collecte des cookies :</li>
							<p>sortir gratos se réserve le droit d'installer des cookies afin de recueillir et stocker des informations lorsqu'un utilisateur visite le site. Ces informations permettent d'anticiper les services qui peuvent intéresser l'utilisateur, de mesurer et analyser le trafic et de mener des recherches sur les services proposés dans le but d'améliorer le fonctionnement et la navigation du site.</p>
			...
			<div class="col-md-12">
				<ul>
					...
					<ul>
						...
						<p>Sortir Gratos s’efforce au mieux de maintenir accessibles de manière permanente le Site Sortir Gratos et services qu’elle propose ; sans pour autant être tenue à une quelconque obligation à cet égard vis-à-vis des utilisateurs. Sortir Gratos peut donc interrompre pour toute raison, notamment technique ou éditoriale (par exemple en cas de maintenance ou de mise à jour) l’accès aux Sites, sans préavis ni information préalable des Utilisateurs, et ce sans pouvoir être tenue pour responsable des conséquences de ces interruptions aussi bien à l’égard des Utilisateurs que de tout tiers.<br />
						Par ailleurs, Sortir Gratos ne saurait être tenue pour responsable dans le cas où les Utilisateurs ne parvenaient pas à accéder à tout ou partie du Site Sortir Gratos du fait de tout défaut technique ou de tout problème, notamment et non limitativement liés à :
							<ul>
					...
					<ul>
						<li>IV. Inscription / création du compte utilisateur</li>
							<ul>
								...
								<p>L'accès à certains services disponibles sur le Site Sortir Gratos peut être soumis à la condition préalable de l’identification de l’Utilisateur, la validation d’un formulaire d’inscription et ainsi à l’utilisation d’un compte spécifique (ci-après dénommé « Compte Contributeur »).<br />
								L’Utilisateur est informé que l’accès à l’ensemble des fonctions de différents services et Site Sortir Gratos peut nécessiter la création de plusieurs Comptes Utilisateurs distincts.<br />
								Les mineurs ne peuvent s'inscrire et créer un Compte Contributeur Sortir Gratos qu'avec l’accord des personnes titulaires de l’autorité parentale. L'utilisation du Compte Contributeur Sortir Gratos par un mineur reste sous l'entière responsabilité des personnes détenant l’autorité parentale.<br />
								A l’occasion de la création de chaque Compte Contributeur Sortir Gratos, l’Utilisateur doit choisir un identifiant personnel ainsi qu’un mot de passe. Lors de cette inscription, l’Utilisateur est également invité à communiquer à Sortir Gratos via un formulaire d’inscription, des informations à caractère personnel (telles que, à titre indicatif : nom, prénom, adresse électronique, numéro de téléphone, adresse postale, etc.) qui feront l’objet d’un traitement dans les conditions définies au point V ci-après. L’Utilisateur est informé du caractère obligatoire ou facultatif des réponses à fournir à cette occasion.<br />
								Tout Utilisateur s’engage à communiquer toutes les informations obligatoires requises par le formulaire d’inscription. A défaut de réponse aux questions obligatoires, l’Utilisateur ne pourra valider la création du Compte Contributeur Sortir Gratos.<br />
								L’Utilisateur s’engage à ne créer et utiliser qu’un seul Compte Contributeur Sortir Gratos et à ne communiquer que des informations exactes et à jour et qui ne portent pas atteinte aux droits de tiers (notamment utilisation dans l’adresse électronique communiquée ou dans l’identifiant : du nom patronymique, de la marque ou d’œuvres de l’esprit protégées par le droit de la propriété intellectuelle d’un tiers) ou contraires à l’ordre public et aux bonnes mœurs.<br />
							...
							e même, tout Utilisateur qui se créerait plusieurs Comptes Contributeur Sortir Gratos et qui communiquerait des données d’identification erronées pourrait voir l’ensemble de ses Comptes Contributeur Sortir Gratos suspendus et/ou supprimés par Sortir Gratos.<br />
							</p>
					
						<li>IV-2. Confirmation de l’inscription</li>
							<p>Sortir Gratos informe l’Utilisateur de son inscription et la création du Compte Contributeur Sortir Gratos en lui adressant automatiquement un courrier électronique à l'adresse électronique communiquée dans le formulaire d’inscription. Ce message électronique comporte notamment un lien hypertexte et/ou un code d’activation permettant à l’utilisateur de valider définitivement son inscription et la création du Compte Contributeur Sortir Gratos.<br />
							Sortir Gratos ne pourra en aucun cas être tenue responsable si les données de l’Utilisateur relatives à son inscription ne lui parviennent pas ou lui parviennent partiellement illisibles en raison d’incompatibilités ou défaillances techniques imputables notamment aux installations de l’Utilisateur (serveur Internet, matériels, logiciels, etc.).</p>
						<li>IV-3. Utilisation des identifiants et mots de passe</li>
							<p>Les informations communiquées à Sortir Gratos par l’Utilisateur dans le cadre de son inscription sont strictement confidentielles. Les Utilisateurs reconnaissent avoir l'entière responsabilité de la conservation et du caractère confidentiel de leurs identifiants et mots de passe.<br />
							Toute connexion au Site Sortir Gratos via un Compte Contributeur Sortir Gratos et/ou transmission de données effectuées en utilisant un Compte Contributeur Sortir Gratos sera présumée avoir été effectuée par le titulaire dudit Compte Contributeur Sortir Gratos et sous sa responsabilité exclusive.<br />
							En cas d'utilisation frauduleuse constatée de ses données d’identification (identifiant et mot de passe), tout Utilisateur s’engage à en informer Sortir Gratos par écrit dans les plus brefs délais.</p>
					</ul>
				</ul>
					<ul>
						<li>V.Protection des données à caractère personnel</li>
							<ul>
								...
								<p>Sortir Gratos peut constituer un fichier comportant des informations communiquées par les Utilisateurs du Site Sortir Gratos, notamment lors de la création d’un Compte Contributeur Sortir Gratos. L’Utilisateur est informé de la collecte et du traitement des données le concernant par Sortir Gratos et consent, du fait de l’acceptation des présentes Conditions Générales d’Utilisation, à la constitution de ce fichier et au traitement de ses données à caractère personnel.<br />
								Dans ce cadre, Sortir Gratos s’engage à respecter la législation en vigueur en France relative à la protection de la vie privée et aux données à caractère personnel des Utilisateurs du Site Sortir Gratos, ainsi que la confidentialité de ces dernières.<br />
